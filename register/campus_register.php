...
<html lang="en" class="no-js">
	<head>
		...
		<title>register as campus ambassador</title>
...
$(document).ready(function () {
        $("#submit").click(function () {
			...
			$.post("database_campus.php", { name: name,college: college,year: year,phone: phone,email: email }, function (data) {
                if (data == "1")
                    $("#afterSubmit").text("Thanks for Registering as Campus Ambassador. An Atmos ID has been sent to your Email.");
                else
                    $("#afterSubmit").text("Thanks for Registering as Campus Ambassador. An Atmos ID has been sent to your Email.");
            });
			$("#input-1").val('');
	...
	<body>
		<div class="container">
			<header class="codrops-header">
				...
				<h2 style="color:#FFFFCC;">Register As Campus Ambassador</h2>
